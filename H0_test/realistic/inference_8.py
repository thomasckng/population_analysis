...
def scipy_minimize(i):
    return minimize(realistic_jsd,
                    x0=[uniform(10,100), uniform(1,5), uniform(10,50), uniform(0,10), uniform(0,1), uniform(0,10), uniform(50,200), uniform(0,10)],
                    bounds = ((10,100), (1,5), (10,50), (0,10), (0,1), (0,10), (50,200), (0,10)), args=(i,)).x
